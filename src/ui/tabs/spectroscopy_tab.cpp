...
namespace parallax::ui::tabs
{
    ...
    SpectroscopyTab::SpectroscopyTab(BitmapFont& font)
        : m_font(font)
    {
    }

    void SpectroscopyTab::update(f64 /*delta_time*/)
    {
    }

    void SpectroscopyTab::render(VkCommandBuffer cmd, const shell::ViewportRect& viewport)
    {
        ...
        constexpr std::array<std::string_view, 4> kAsciiArt = {
            "   ||| | || ||| || |",
            "   ||| | || ||| || |",
            "  -------------------",
            "   400nm     700nm"
        ...
        constexpr std::array<std::string_view, 3> kDescription = {
            ...
            "Analyse light from selected targets",
            "to derive composition and velocity."
        };
    ...
    void SpectroscopyTab::on_input(const shell::InputEvent& /*event*/, const shell::ViewportRect& /*viewport*/)
    {
    }
}
