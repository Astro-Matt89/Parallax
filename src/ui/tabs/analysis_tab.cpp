...
namespace parallax::ui::tabs
{
    ...
    AnalysisTab::AnalysisTab(BitmapFont& font)
        : m_font(font)
    {
    }

    void AnalysisTab::update(f64 /*delta_time*/)
    {
    }

    void AnalysisTab::render(VkCommandBuffer cmd, const shell::ViewportRect& viewport)
    {
        ...
        constexpr std::array<std::string_view, 6> kAsciiArt = {
            "   ^",
            "   |    *",
            "   | *    *  *",
            "   |   *",
        ...
        constexpr std::array<std::string_view, 3> kDescription = {
            ...
            "Plot, fit, and cross-reference",
            "records pulled from the archive."
        };
    ...
    void AnalysisTab::on_input(const shell::InputEvent& /*event*/, const shell::ViewportRect& /*viewport*/)
    {
    }
}
